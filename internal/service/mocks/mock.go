...
func (mr *MockWalletMockRecorder) BaseWallets(count, balance any) *gomock.Call {
...
func (mr *MockWalletMockRecorder) CreateRandomWallets(count, balance any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockWalletMockRecorder) CreateWallet(arg0 any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockWalletMockRecorder) GetWalletBalance(address any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockTransactionMockRecorder) GetLastTransactions(count any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockTransactionMockRecorder) TransferFunds(from, to, amount any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
